...
proteininfo = proteininfo(4:end-2);
proteininfo = str2num(proteininfo);
pp = genbankinfo.CDS.translation;

aaposition = (proteininfo-start-2)/3;
pp(aaposition:end - (length(pp)-aaposition));
%At nucleotide position 1256 in the sequence exists the conserved homeobox domain of the protein.
%This occurs are around the P amino acid at position 297 (out of 313) in the amino
%acid sequence.
